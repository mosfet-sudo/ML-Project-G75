...
## Contributors  
- **Elijah Cullinan**: MetroPT3 preprocessing, cumulative feature design, SVM/kNN/DT ensemble training, and Discussion section (environmental factor analysis).  
- **Amelia King**: Literature review (7 references, Section 2), Introduction, NASA Random Forest/MLP implementation, and idea integration (RQ alignment).  
- **Xinyu Xu**: NASA C-MAPSS feature engineering (thermodynamic ratios, baseline deviation), KNN/NB model tuning/evaluation, Results section drafting, and visualization (Figure 3/5).  
